...
```{r hout3D, fig.cap='Doorsnede van een stam of tak, met aanduiding van een aantal weefseltypes en anatomische kenmerken'}
...
```{r boorkernen, fig.cap = 'Twee stukken historisch bouwhout waarvan de opgemeten jaarringbreedtes worden weergegeven in een grafiek. De twee jaarringreeksen vertonen onderling een sterk gelijklopend patroon.'}
