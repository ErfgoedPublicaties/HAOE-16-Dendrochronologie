...
```{r groeisnelheid, fig.cap = 'Drie stukken eikenhout. Het stuk bovenaan is snel gegroeid en heeft ca. 31 brede ringen, het stuk onderaan is traag gegroeid en telt ca. 92 smalle jaarringen. Bij het middelste stuk is het jaarringpatroon sterk verstoord. Bij de onderste twee stukken is het spinthout zwaar aangetast door insectenvraat.', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r wankant, fig.cap = 'Stuk archeologisch eikenhout waarop de wankant zichtbaar is. De afgeronde vorm volgt de omtrek van de originele stam ((c) Van Daalen Dendrochronologie).', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
