...
Het opmeten resulteert in een bestand waarin de meting van elke groeiringbreedte staat geregistreerd (@fig-output). Dergelijke bestanden worden in gespecialiseerde software eenvoudig omgezet naar een grafiek (figuur \@ref(fig:output)) of staafdiagram. Deze bestanden vormen de basis van verdere analyses.
