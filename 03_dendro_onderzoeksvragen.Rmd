...
```{r import, fig.cap='Tonnen, sierpanelen en een dakkap gemaakt uit geïmporteerd eikenhout', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r WOI, fig.cap='Stamdoorsnede van een oude eik waarin er stukken shrapnel uit de Eerste Wereldoorlog aanwzig zijn en het hout lokaal donker kleuren', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
