...
```{r import, fig.cap='Tonnen, wandpanelen en een dakkap gemaakt uit geïmporteerd eikenhout'}
...
```{r WOI, fig.cap='Stamdoorsnede van een oude eik waarin er stukken shrapnel uit de Eerste Wereldoorlog aanwzig zijn en het hout lokaal donker kleuren'}
