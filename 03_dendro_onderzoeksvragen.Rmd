...
```{r import, fig.cap='Tonnen, wandpanelen en een dakkap gemaakt uit geïmporteerd eikenhout', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/Dendro_Figuur29.png")
...
```{r WOI, fig.cap='Stamdoorsnede van een oude eik waarin er stukken shrapnel uit de Eerste Wereldoorlog aanwzig zijn en het hout lokaal donker kleuren', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./figuren/Dendro_Figuur28.jpg")
...
<!-- ToDO: aanvullen dat dit enkel kan met grote datasets van gevoelige jaarringreeksen. pointer years >> -->
<!-- ToDO: klimaatreconstrcuties - grote datasets klimaat-gevoelige jarringreeksen - lage landen/maritiem zeeklimaat lage respons - invloed bosbeheer -->
<!-- ToDo: nieuwe technieken - isotopen hebben potentieel om naast ringbreedte,  in de (nabije) toekomst meer inzicht brenge -->