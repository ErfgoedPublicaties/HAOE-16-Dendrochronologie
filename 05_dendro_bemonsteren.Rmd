...
```{r stamschijf2, fig.cap = 'Schematische voorstelling van de doorsnede van een stam. Om het volume te beperken kan ook enkel een deel van de stam bewaard worden voor verder onderzoek (blauwe zone).', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}

knitr::include_graphics("./Figuren/Dendro_Figuur21.png")
...
```{r stamschijf3, fig.cap = 'Een stamstuk van een omgewaaide populier onder de microscoop voor een leeftijdsbepaling.', echo = FALSE, out.width='100%', fig.asp=.75, fig.align='center'}
