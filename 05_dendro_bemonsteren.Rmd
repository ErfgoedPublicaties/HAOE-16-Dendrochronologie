...
```{r boomstamWP, fig.cap = 'Doorsnede van een boomstamwaterput. De plaats (en vorm) waar een staal voor dendrochronologisch onderzoek kan genomen worden is afgelijnd in het geel. (foto: &copy; KLAD).', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
