...
```{r dendrostalen, fig.cap = 'Stalen van archeologisch hout, verpakt en voorzien van een ingevuld vondstkaartje.', echo = FALSE, out.width='80%', fig.asp=.75, fig.align='center'}
