...
```{r meettafel, fig.cap = 'Opstelling met stereomicroscoop en meettafel voor het opmeten van jaarringpatronen.', echo = FALSE, out.width='60%'}
...
knitr::kable(df,
             caption = "Voorbeeld van de berekening van de veldatum voor elke gedateerde jaarringreeks. Bij deze berekening start men bij de einddatering en telt men al dan niet een aantal ontbrekende jaarringen bij in functie van het voorkomen van spinthout of wankant. (W = schors en/of wankant aanwezig)", align = 'l') %>%
        kable_styling(font_size = 12, full_width = F) %>% scroll_box(width = "100%")
